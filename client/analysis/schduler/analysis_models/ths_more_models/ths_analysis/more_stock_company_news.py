...
class THSStockNews(MoreNewsBase):
    '''
    股票-公司-公司新闻（12.公司咨讯）
    '''
    ...
    def __analysis(self):
        ...
        解析
        '''
#         with open('./ths_companynews_list.html', 'r') as f:
...
def load_data():
    ...
    加载网页html
    '''
    if not os.path.exists('./ths_companynews_list.html'):
        response = urllib2.urlopen('http://stock.10jqka.com.cn/companynews_list/')
        with open('./ths_companynews_list.html', 'w') as f:
