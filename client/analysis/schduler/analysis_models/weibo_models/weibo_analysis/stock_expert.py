...
#             f.write(self.html_data)
    ...
    def __expert(self, stock_html_data):
        ...
        for expert in expert_list:
            weibo_usercard = expert.xpath\
            (r'div[@class="info_name W_fb W_f14"]//a[@class="S_txt1"]/@usercard')\
            [0].encode()
            weibo_id = weibo_usercard.split('=').pop()
            #这个url要上传到服务器
            url = expert.xpath(r'div[@class="info_name W_fb W_f14"]//a[@class="S_txt1"]/@href'\
                                    )[0].encode()
