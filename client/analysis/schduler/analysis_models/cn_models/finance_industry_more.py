...
class CNIndustry(CNMoreNews):
    '''
    财经产经模块
    '''
    tag = {'rule':'/html/head/title/text()',
           'tag':'财经-产业动态-21CN财经频道-21CN.COM'}
    ...
    def __analysis(self):
        ...
        解析
        '''
#         with open('./21cn_industry.html', 'r') as f:
...
def load_data():
    ...
    加载html
    '''
    if not os.path.exists('./21cn_industry.html'):
        response = urllib2.urlopen('http://finance.21cn.com/news/industry/')
        with open('./21cn_industry.html', 'w') as f:
