...
from schduler.analysis_models.cn_models.detail_picture_news import CNNewsDetail
from schduler.analysis_models.cn_models.detail_words_news import CNDetail
