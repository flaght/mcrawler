...
class CNProduction(CNMoreNews):
    """
    更多新闻要闻
    """
    tag = {'rule': '/html/head/title/text()',
           'tag': '财经-行业分析-21CN财经频道-21CN.COM'}
    ...
    def __analysis(self):
        ...
        解析
        """
#         with open('./21cn_stock_news.html', 'r') as f:
...
def load_data():
    ...
    加载html
    """
    if not os.path.exists('./21cn_stock_news.html'):
        response = urllib2.urlopen('http://finance.21cn.com/stock/hyfx/')
        with open('./21cn_stock_news.html', 'w') as f:
