...
class THSStockFirstPage(MoreNewsBase):
    """
    股票首页（15.股票频道）
    """
...
#             self.html_data = f.read()
    ...
    def __stocks_research(self, doc):
        ...
        """
        model = '个股研究'
        more_news = doc.xpath(r'//div[@class="ui-section clearfix"]//div[@class="ui-box"]//ul//li//a')
    ...
    def __securities_news(self, doc):
        ...
        """
        model = '证劵要闻'
        more_news = doc.xpath(r'//div[@class="ui-box noborder bondnews"]//div[@class="secnews-title"]//h3//a')
        for new in more_news:
            title = new.xpath(r'text()')[0]
            url = new.xpath(r'@href')[0]
            self.set_analyzed_info(title, self._type, model, None, url)
