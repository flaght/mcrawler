...
class AnalysisConfManager(object):
    ...
    def __read_hbase_info(self):
        ...
        self.hbase_info['type'] = int(filer_opcode.hbase)
    ...
    def __read_redis_info(self):
        ...
        self.redis_info['type'] = int(filer_opcode.redis)
    ...
    def __read_ftp_info(self):
        ...
        self.ftp_info['type'] = int(filer_opcode.ftp)
