...
from scheduler.analysis_models.cn_models.cn_manage import CNManager
from scheduler.analysis_models.ths_more_models.ths_manage import ThsNewsManager
from scheduler.analysis_models.weibo_models.weibo_analysis.weibo_manage import WBManager
from scheduler.analysis_models.yicai_models.yicai_manage import YiCaiManager
from scheduler.storage.hbase_manage_model import hbase_manager
...
if __name__ == '__main__':
    data_to_redis = Analyst(1, 't.10jqka.com.cn', 'd7fc75dd5675eb0c70534488710a8c21')
