...
class THSOriginalSole(MoreNewsBase):
    """
    原创独家报道（11.独家报道）
    """
    ...
    def __analysis(self):
        ...
        解析
        """
#         with open('./ths_dujiabd_list.html', 'r') as f:
...
def load_data():
    ...
    加载网页html
    """
    if not os.path.exists('./ths_dujiabd_list.html'):
        response = urllib2.urlopen('http://yuanchuang.10jqka.com.cn/dujiabd_list/')
        with open('./ths_dujiabd_list.html', 'w') as f:
