...
class THSStockNotice(MoreNewsBase):
    """
    股票-公司-公司解读（13.公告解读）
    """
    ...
    def __analysis(self):
        ...
        解析
        """
#         with open('./ths_ggjd_list.html', 'r') as f:
...
def load_data():
    ...
    加载网页html
    """
    if not os.path.exists('./ths_ggjd_list.html'):
        response = urllib2.urlopen('http://stock.10jqka.com.cn/ggjd_list/')
        with open('./ths_ggjd_list.html', 'w') as f:
