...
#define SB_LHB_LIST              602  //https://xueqiu.com/stock/f10/bizunittrdinfo.json?date={%d}
#define SB_LHB_DETAIL            603  //https://xueqiu.com/stock/f10/bizunittrdinfo.json?symbol={%tstcode}&date={%d}
...
class XueqiuTaskManager {
 ...
 private:
  ...
  void CreateLHBList(const console_logic::KafkaInfo& kafka, const base_logic::TaskInfo& task);
  void CreateLHBDetail(const console_logic::KafkaInfo& kafka, const base_logic::TaskInfo& task);
