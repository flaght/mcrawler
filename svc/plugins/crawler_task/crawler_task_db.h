...
public:
  ...
  bool
  GetTaskPlatTaskDescription(std::list<base_logic::TaskPlatDescription> *list);

  void
  BatchFectchTaskPlatInfo(std::list<base_logic::TaskPlatDescription> *list);
  ...
  void UpdateTaskLog(const int64 task_id, const int8 state);

public:
  static void CallBackFectchBatchTask(void *param, base_logic::Value *value);
